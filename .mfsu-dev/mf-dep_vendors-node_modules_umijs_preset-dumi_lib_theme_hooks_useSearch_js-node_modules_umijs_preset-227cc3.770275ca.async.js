(self["webpackChunkoli_ui"] = self["webpackChunkoli_ui"] || []).push([["mf-dep_vendors-node_modules_umijs_preset-dumi_lib_theme_hooks_useSearch_js-node_modules_umijs_preset-227cc3"],{
...
function _apis() {
  const data = _interopRequireDefault(__webpack_require__(/*! @@/dumi/apis */ "./src/.umi/dumi/apis.json"));
...
const getDemoUrl = (demoId, htmlSuffix) => {
  ...
  `${((_window2 = window) === null || _window2 === void 0 ? void 0 : _window2.routerBase) || ''}/`.replace(/\/\/$/, '/'), getDemoRouteName(), '/', demoId, isBMW() ? '/index.html' : `${htmlSuffix ? '.html' : ''}`].join('');
};
/**
...
const useBuiltinSearch = keywords => {
  ...
  (0, _react().useEffect)(() => {
    setMetas(routes.filter(({
      ...
      result.push(...(((_route$meta2 = route.meta) === null || _route$meta2 === void 0 ? void 0 : _route$meta2.slugs) || []).filter(({
        value
      }) => value !== route.title).map(slug => ({
        title: slug.value,
